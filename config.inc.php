<?php
        ...
        $conf['servers'][0]['desc'] = $_ENV["POSTGRES_HOSTNAME"];
        ...
        //$conf['servers'][1]['local'] = false;
        //$conf['servers'][1]['desc'] = 'Vima Postgres Docker';
        //$conf['servers'][1]['host'] = '172.17.0.2';
        //$conf['servers'][1]['port'] = 5432;
        //$conf['servers'][1]['sslmode'] = 'allow';
        //$conf['servers'][1]['defaultdb'] = 'vima';
